...
const Auth = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if (!error)
      toast.success(
        `You are successful ${isLoginForm ? "Submit" : "Registered"}`
      );
    resetForm();
  };
        ...
        <div className="auth__body">
          <div className="auth__main">
            <div className="auth__animate">
              <Lottie play loop mode="normal" animationData={authAnim} />
            </div>
              ...
              {!isAuthenticated && (
                <form className="auth__form" onSubmit={submitHandler}>
                  ...
                  <p className="auth__facebook">
                    ...
                    {isLoginForm ? "Login" : "Register"} into Facebook
                  </p>
                  {isLoginForm && (
                    <span className="auth__pass">Forgot your password?</span>
                  )}
                </form>
              )}
